...
const chatCol = client.db('chatgpt2').collection('chat')
const roomCol = client.db('chatgpt2').collection('chat_room')
const userCol = client.db('chatgpt2').collection('user')
const configCol = client.db('chatgpt2').collection('config')
const usageCol = client.db('chatgpt2').collection('chat_usage')
